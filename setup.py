# -*- coding: utf-8 -*-
"""Installer for the collective.volto.blocksfield package."""
...
setup(
    ...
    project_urls={
        ...
        # 'Documentation': 'https://collective.volto.blocksfield.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = collective.volto.blocksfield.locales.update:update_locale
    """,
)
